...
def pace():
    try:
        ...
        print("Nenhum treino registrado para calcular o pace.")
        return
    except Exception as e:
    ...
    for i in range(len(conteudo)):
        if conteudo[i].startswith("ID: T"):  
            id_treino = conteudo[i].strip()
            distancia = 0
            tempo = 0
            ...
            if distancia > 0 and tempo > 0:
                ...
                print(f"{id_treino} - Pace: {minutos}min {segundos:02d}s/km")
            else:
                print(f"{id_treino} - Dados insuficientes para calcular o pace.")
    print()
...
def menu():
    ...
    print("\033[1;33m[ 6 ] Aleatorio\033[m")
    print("\033[1;33m[ 7 ] Pace\033[m")
    print('[ 0 ] Sair')
...
def aleatorio():
    ...
    try:
        ...
        print("Treino aleatório selecionado:", treino)
        return treino
